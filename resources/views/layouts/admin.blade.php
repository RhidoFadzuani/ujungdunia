    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <h3 class="mb-0">LAWAS</h3>
                <p class="text-white mb-0">Laporan Warga Subang</p>
            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                       ...
                       <li class=" nav-item dropdown">
                        ...
                        <a class="nav-link dropleft-toggle" data-toggle="dropdown" href="#" role="button"
                            aria-haspopup="true" aria-expanded="false">{{Auth::guard('admin')->user()->nama_petugas ?? ''}}</a>
